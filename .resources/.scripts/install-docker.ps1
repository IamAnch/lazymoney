...
$ProgressPreference = 'Continue'
Write-Output "NOTE: IF YOU READ THIS MESSAGE YOU ARE USING AN OLD VERSION OF THE LAZYMONEY PROJECT. PLEASE DOWNLOAD THE LATEST VERSION FROM https://github.com/IamAnch/lazymoney"
Write-Output "THIS IS NOW A LEGACY SCRIPT,EVEN IF IT IS STILL USABLE AND WORKING, IT IS CONSIDERED DEPRECATED AND IS ONLY PRESENT TO PROVIDE SUPPORT TO PREVIOUS VERSIONS OF THE LAZYMONEY PROJECT. "
